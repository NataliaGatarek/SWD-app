    ...
    <div>
      <Card className={classes.root}>
        ...
        <CardActions disableSpacing>
          ...
          {/* //This button will lead to log in page if the user is not loged in// */}
          <IconButton
        ...
        <Collapse in={expanded} timeout="auto" unmountOnExit>
          <CardContent>
            ...
            <Typography paragraph>Parents:</Typography>
            <Typography paragraph>Answer:</Typography>
            <Typography paragraph>Great parents:</Typography>
            <Typography paragraph>Answer:</Typography>
            <Typography paragraph>Breeding dog:</Typography>
            <Typography paragraph>Answer:</Typography>
            <Typography paragraph>Heatlh:</Typography>
            <Typography paragraph>Answer:</Typography>
